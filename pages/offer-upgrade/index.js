    ...
    <div className="offer-upgrade">
      ...
      <div className="offer-upgrade products-container">
        <div className="product">
          <img src="/static/svg/level-1-member.svg" />
          <h3>Basic</h3>
          <h1>$ 00.00/month</h1>
          ...
          <ul>
            <li>
              <img src="/static/svg/correct.svg" />
            ...
            <li>
              <img src="/static/svg/blocked.svg" />
              <p>Offline viewing</p>
            </li>
            <li>
              <img src="/static/svg/blocked.svg" />
        ...
        <div className="product">
          <img src="/static/svg/level-2-member.svg" />
          <h3>Advanced</h3>
          <h1>$ 00.00/month</h1>
          <button>Free Trial</button>
          <a href="">Skip free trial</a>
        ...
        <div className="product">
          <img src="/static/svg/level-3-member.svg" />
          <h3>Enthusiast</h3>
          <h1>$ 00.00/month</h1>
          <button>Free Trial</button>
          <a href="">Skip free trial</a>
